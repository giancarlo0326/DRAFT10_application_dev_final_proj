                ...
                <div class="centered-container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <button id="uploadProfileButton" class="btn btn-primary mt-3" onclick="toggleEdit('passwordForm')">Upload Video</button>
                            <button id="uploadProfileButton" class="btn btn-primary mt-3" onclick="toggleEdit('passwordForm')">Upload Thumbnail</button>
                        </div>
                    </div>
                </div>
            </div>
